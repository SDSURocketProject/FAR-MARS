...
public:
    ...
    QcValuesItem* addValues(float position, int highPres);
    QcArcItem* addArc(float position);
    QcColorBand* addColorBand(float position, int highPres);
...
class QCGAUGE_DECL QcColorBand : public QcScaleItem
{
    Q_OBJECT
public:
    explicit QcColorBand(QObject *parent = 0, int highPres = 0);
    void draw(QPainter*);
...
class QCGAUGE_DECL QcValuesItem : public QcScaleItem
{
    Q_OBJECT
public:
    explicit QcValuesItem(QObject *parent = 0, int highPres = 0);
    void draw(QPainter*);
    void setStep(float step);
    void setColor(const QColor& color);
private:
