...
/**
 * @brief Calculates the 16 bit CCITT-FALSE checksum for an array of bytes.
 *
 * @param[in] *data Pointer to the data that the CRC will be performed on
 * @param[in] Size of the array that the CRC will be performed on
 *
 * @return Returns the calculated CRC.
 * @retval COM_NULL_POINTER The data pointer points to null, the return is a CRC that will likely not be a valid CRC
 */
