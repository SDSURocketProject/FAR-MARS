...
#define PRESSURE_CHAMBER_MAX_PRESSURE 1500.0f
...
#define PRESSURE_METHANE_BIAS_ALPHA 32.0f
#define PRESSURE_LOX_BIAS_ALPHA 405.0f
#define PRESSURE_HELIUM_BIAS_ALPHA 0.0f
#define PRESSURE_CHAMBER_BIAS_ALPHA 173.0f-145.0f
#define PRESSURE_CHAMBER_GAIN_CORR_ALPHA 1.05f

#define PRESSURE_METHANE_BIAS_BETA 32.0f
#define PRESSURE_LOX_BIAS_BETA 405.0f
#define PRESSURE_HELIUM_BIAS_BETA 0.0f
#define PRESSURE_CHAMBER_BIAS_BETA 173.0f+598.0f
#define PRESSURE_CHAMBER_GAIN_CORR_BETA 1.05f
