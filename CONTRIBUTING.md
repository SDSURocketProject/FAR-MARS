...
### How to Contribute
- Select an issue to work on from the list [here](https://github.com/SDSURocketProject/FAR-MARS/issues)

- Clone the repo to your local computer. 
	```
	git clone https://github.com/SDSURocketProject/FAR-MARS.git
	```
...
- When you're finished making changes to your branch, submit a new pull request to merge your branch into master [here](https://github.com/SDSURocketProject/FAR-MARS/pulls)
